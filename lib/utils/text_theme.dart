...
TextTheme smallText = TextTheme(
    headline1: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 64),
    headline2: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 40),
    headline3: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 32),
    headline4: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 24),
    headline5: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 18),
    headline6: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 16),
    bodyText1: GoogleFonts.nunito(fontSize: 12, fontWeight: FontWeight.normal),
    bodyText2: GoogleFonts.nunito(
      fontSize: 14,
      fontWeight: FontWeight.normal,
    ),
